...
export class VRFCoordinatorMock__factory extends ContractFactory {
  ...
  override connect(runner: ContractRunner | null): VRFCoordinatorMock__factory {
    return super.connect(runner) as VRFCoordinatorMock__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): VRFCoordinatorMockInterface {
    return new Interface(_abi) as VRFCoordinatorMockInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): VRFCoordinatorMock {
    return new Contract(address, _abi, runner) as unknown as VRFCoordinatorMock;
  }
}
