...
type RaffleDescriptionProps = {
  prize: BigNumberish;
  description?: string;
  prizeForLevel: number[];
  winnersForLevel: number[];
};
export const RaffleDescription: FC<RaffleDescriptionProps> = ({
  prize,
  description,
  prizeForLevel,
  winnersForLevel,
  ...
  return (
    ...
    >
      ...
      >
        <Flex flexDirection="column">
          ...
          <Text
            ...
            lineHeight={{ sm: '22px', md: '42px', lg: '22px', xl: '42px', '2xl': '65px' }}
          >
            {beautifyAmount(bigNumberToNumber(prize, { precision: 0 }), { precision: 0 })}{' '}
            <Text
              as="span"
      ...
      >
        ...
        <table className="raffle-description__table">
          <thead>
            <tr>
              <th>Levels</th>
              <th>Winners</th>
