...
import { CreateRaffleWithTitleProps } from '@/hooks/raffle/useRaffle';
...
type AddRaffleRoundProps = {
  onClose: () => void;
  onSubmit: (props: CreateRaffleWithTitleProps) => Promise<void>;
};
export const AddRaffleRound: FC<AddRaffleRoundProps> = ({ onClose, onSubmit }) => {
